...
import { animateWithGGsapTimeline } from "../utils/animation"
...
const Model = () => {
    ...
    useEffect(() => {
      if(size === 'large') {
        animateWithGGsapTimeline(tl, small, smallRotation, "#view1", "#view2", {
      ...
      if(size === 'small') {
        animateWithGGsapTimeline(tl, large, largeRotation, "#view2", "#view1", {
